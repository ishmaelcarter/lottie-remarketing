...
dir_path = "lottie_ads/OCS/json/"
dirs = os.listdir(dir_path)
dirs.remove('.DS_Store')
for dir in dirs:
    files = ["lottie_ads/OCS/json/" + dir + "/" + dir + "_a.json","lottie_ads/OCS/json/" + dir + "/" + dir + "_b.json"]
    file1 = files[0]
    file2 = files[1]
    json = []
    ...
    def makeHtml(dimensions):
        os.mkdir("lottie_ads/OCS/OCS_" + str(dimensions[0]) + "x" + str(dimensions[1]))
        filename = "lottie_ads/OCS/OCS_" + str(dimensions[0]) + "x" + str(dimensions[1]) + "/index.html"
        ...
        file.write("<title>OCS " + str(dimensions[0]) + "x" + str(dimensions[1]) + "</title>")
    ...
    def makeLottie(dimensions):
        os.mkdir("lottie_ads/OCS/OCS_" + str(dimensions[0]) + "x" + str(dimensions[1]) + "/scripts")
        with open("lottie.js") as f:
            with open("lottie_ads/OCS/OCS_" + str(dimensions[0]) + "x" + str(dimensions[1]) + "/scripts/lottie.js", "w") as f1:
                for line in f:
                    f1.write(line)
    ...
    def makeCss(dimensions):
        filename = "lottie_ads/OCS/OCS_" + str(dimensions[0]) + "x" + str(dimensions[1]) + "/style.css"
        file = open(filename, 'w')
    ...
    def makeImages(dimensions):
        os.mkdir("lottie_ads/OCS/OCS_" + str(dimensions[0]) + "x" + str(dimensions[1]) + "/images")

    def copyImages(dimensions):
        source = 'lottie_ads/OCS/images/'
        dest1 = "lottie_ads/OCS/OCS_" + str(dimensions[0]) + "x" + str(dimensions[1]) + "/images/"
    ...
    def makeJs(json):
        filename = "lottie_ads/OCS/OCS_" + str(dimensions[0]) + "x" + str(dimensions[1]) + "/scripts/index.js"
        file = open(filename, 'w')
